  ...
  experience: [
    ...
    },
    {
      ...
      achievements: [
        {
          date: "2016년 상반기 — 퇴사",
          title: "임베디드 소프트웨어 라이브러리 개발 전담",
          desc: "하드웨어에 의존적인 코드와 어플리케이션 제어 로직이 혼재 되어 있던 기존 레거시 코드를 자체 개발한 임베디드 SW 모듈 적용하여 리팩토링 수행. 임베디드 시스템에 최적화된 9종 이상의 재사용 및 확장 가능한 모듈을 개발하여 재검증 공수를 줄이고 생산성 및 품질 향상"
        },
        {
          date: "2013년 하반기 — 2014년 하반기",
          title: "HMI(Human Machine Interface) SW 개발 주도",
          desc: "터치스크린, RGB565 컬러 디스플레이, SD카드 마운트(FATFS), USB Mass Storage Class(On-board nandflash) 기능을 지원하는 MCU 기반의 HMI SW 개발"
        },
        {
          date: "2012년 상반기 — 퇴사",
          title: "산업용 제어 시스템 SW 개발",
          desc: "삼성 디스플레이 다채널 팬 제어 장비, 농촌진흥청 스마트팜, SK IDC센터 냉수식 공조 시스템, 네이버 그린팩토리 바닥공조 시스템 등 39종 이상의 산업용 제어시스템을 보드 브링업부터 제어 로직 구현까지 개발"
        }
      ]
    }
  ],
      ...
      details: [
        ...
        },
        {
          ...
          content: [
            ...
            {
              type: 'bullet',
              text: "이를 통해 신규 프로젝트 착수 시 불필요한 재검증 공수를 줄이고, 조직의 생산성과 품질 안정성 개선."
            },
            {
              type: 'toggle',
              title: 'Module List',
