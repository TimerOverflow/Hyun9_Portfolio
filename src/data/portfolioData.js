                  ...
                  children: [
                    {
                      ...
                      content: [
                        "서버 환경에 접속한 후 아래의 스크립트를 순차적으로 실행하여 SMTP 설정을 완료합니다.",
                        {
                          type: 'code',
                          language: 'bash',
      ...
      details: [
        ...
        },
        {
          ...
          content: [
            ...
            {
              type: 'bullet',
              text: "다양한 센서 및 액추에이터와 연동되는 스마트팜 시스템의 HMI 화면 구성 및 통신 인터페이스 개발.",
              children: [
                {
                  type: 'toggle',
                  title: '스마트팜 시스템 HMI (이미지 삽입 예시)',
                  content: [
                    { type: 'bullet', text: "농촌진흥청 다양한 센서로부터 획득한 데이터를 이용하여 자동화한 스마트팜 프로젝트입니다." },
                    { type: 'bullet', text: "HMI는 본체 제어부와 RS-485 통신으로 인터페이스하고, 상위 관제 시스템과 통신을 중계합니다." },
                    {
                      type: 'image',
                      src: '/SampleImage.png',
                      alt: '스마트팜 HMI 예시 화면',
                      caption: 'HMI 구동 화면 및 센서 연동 예시'
                    }
                  ]
                }
              ]
